    ...
    <div class="col-md-5">
        ...
        <main class="form-signin">
            ...
            <form action="/login" method="post">
                ...
                <it type="email" id="inputEmail" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Email address" value="{{ old('email') }}" required autofocus>
                @error('email')
